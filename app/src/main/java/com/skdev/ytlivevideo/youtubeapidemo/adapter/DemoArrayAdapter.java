...
package com.skdev.ytlivevideo.youtubeapidemo.adapter;
 ...
 */
public final class DemoArrayAdapter extends ArrayAdapter<com.skdev.ytlivevideo.youtubeapidemo.adapter.DemoListViewItem> {

  private final LayoutInflater inflater;

  public DemoArrayAdapter(Context context, int textViewResourceId, List<com.skdev.ytlivevideo.youtubeapidemo.adapter.DemoListViewItem> objects) {
  ...
  public View getView(int position, View view, ViewGroup parent) {
    if (view == null) {
      view = inflater.inflate(R.id.list_item, null);
    }
